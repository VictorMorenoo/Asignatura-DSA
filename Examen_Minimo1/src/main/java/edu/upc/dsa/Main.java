...
public class Main {
    ...
    public static final String PATH = "http://localhost:8080/swagger/";
    ...
    public static HttpServer startServer() {
        ...
        beanConfig.setContact("victor.moreno.barrera@estudiantat.upc.edu");
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(String.format("REST API started at "
                + "%s\nHit enter to stop it...",PATH));
